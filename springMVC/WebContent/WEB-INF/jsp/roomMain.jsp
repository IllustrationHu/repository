					...
					<div class="page-content">
						<div class="page-header">
							<h1>主页
								<small>
									...
									空房[<a href="#">${emptyRoomNum }</a>]&nbsp;&nbsp;
									在住[<a href="#">${livingRoomNum }</a>]&nbsp;&nbsp;
									欲离[<a href="#">${leavingRoomNum }</a>]&nbsp;&nbsp;
									欲抵[<a href="#">0</a>]&nbsp;&nbsp;
						...
						<div class="row">
								<c:forEach items="${roomList }" var="room">
									...
									<%-- <c:choose>
										<c:when test="${room.customer != null && room.customer != '' }">
										...
										<c:otherwise>
											<c:if test="${room.state == 0 }">
												<div class="col-xs-2 col-sm-2 col-md-1 col-lg-1"  style="background-color:orange;border:1px solid gray;height:88px;">
											</c:if>
											<c:if test="${room.state == 2 }">
												<div class="col-xs-2 col-sm-2 col-md-1 col-lg-1"  style="background-color:yellow;border:1px solid gray;height:88px;">
											</c:if>
										</c:otherwise>
									</c:choose> --%>
					            	<div class="col-xs-2 col-sm-2 col-md-1 col-lg-1"  style="background-color:${room.bgcolor};border:1px solid gray;height:88px;">
					            		<p>
					            			${room.typeName }(${room.roomid })<br>
					            			${room.customer }${room.stateName }<br>
					            			${room.crPrice }<br>
					            		</p>
					            	</div>
				            	</c:forEach>
